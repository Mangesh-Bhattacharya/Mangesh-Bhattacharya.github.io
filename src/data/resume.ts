...
export const experience: {
  ...
  {
    role: "Cybersecurity Engineer (Freelance) & Bug Bounty Hunter",
    org: "Upwork / Independent Clients",
    location: "Toronto, ON",
    start: "Aug 2025",
    end: "Present",
    bullets: [
      "Architect production-grade User and Entity Behavior Analytics (UEBA) using heuristic analysis and machine learning for real-time anomaly detection.",
      "Design high-fidelity adversarial emulations leveraging MITRE ATT&CK frameworks and custom payload obfuscation to test EDR/XDR solutions.",
      "Engineer end-to-end SOAR workflows with Python and TensorFlow to accelerate Mean Time to Detect (MTTD) and Mean Time to Respond (MTTR).",
      "Conduct attack-surface management using graph theory and network topology visualization to uncover lateral-movement and privilege-escalation paths.",
      "Identify and validate vulnerabilities in web/mobile apps with Burp Suite, OWASP ZAP, Wireshark, Nmap, FFUF, and Nuclei — delivering remediation-ready reports.",
      "Participate in CTF competitions and bug-bounty programs to continuously refine offensive security skills.",
    ],
  },
  {
    role: "DevSecOps Engineer (Freelance)",
    org: "Independent Clients",
    location: "Toronto, ON",
    start: "Aug 2025",
    end: "Jan 2026",
    bullets: [
      "Built automated vulnerability-scanning pipelines that accelerated detection workflows across client applications and cloud environments.",
      "Delivered actionable remediation reports with reproducible steps, reducing average time-to-patch across CI/CD pipelines.",
      "Performed web and mobile application security assessments, reducing exploitable vulnerabilities and improving deployment confidence.",
      "Executed audits of existing security controls and implemented targeted improvements to reinforce system integrity.",
      "Designed custom security-training programs, increasing client awareness and proactive risk management.",
    ],
  },
  {
    ...
    bullets: [
      "Designed and deployed AI-powered threat detection and observability systems, enhancing SOC visibility and reducing false positives.",
      "Built real-time monitoring pipelines integrating SIEM, IDS, IPS, EDR, and cloud telemetry for unified visibility and automated incident response.",
      "Developed custom dashboards and alerting frameworks (OpenSearch, Kibana, Python) for real-time threat visualization and executive reporting.",
      "Strengthened AWS cloud security through IAM policy design, VPC segmentation, and Zero-Trust architecture aligned with NIST, CIS, and GDPR.",
      "Automated vulnerability management and compliance checks using Ansible and Python; implemented Docker-based secure deployments.",
    ],
  },
  {
    ...
    bullets: [
      ...
      "Designed and enforced AWS security groups, IAM policies, and VPC architectures aligned with NIST and GDPR standards.",
      "Deployed Fluent Bit and integrated system/access logs into OpenSearch Dashboards (ELK Stack) for real-time visibility and forensic analysis.",
      "Automated security configuration, patching, and compliance checks using Ansible playbooks and Docker containerization.",
